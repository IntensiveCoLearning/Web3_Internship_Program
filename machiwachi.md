...
半夜三更做梦梦见忘记打卡了，迷迷糊糊在想有没可能是周日算第一天，或者moving window 来看？惊醒来发现确实是忘记了。

我习惯晚上参与完会议再打卡。今天会议也是在外边参与的，开头十分钟还在开车，最后会议没结束又得继续开车赶路。回到家继续工作，就直接过十二点了。

其实蛮难受的，本来下定决心想坚持的事没做好。但又想大家也不闲，都会有突发的事情，还是能跑下来。

本次活动最终大家都会有不同的收获。我的收获大概就是这个吧，很深刻的一种苦涩吧
...
###  技术上
昨天和今天做了充值监控以及Tally webhook相关的东西。

充值监控可以拿出来讲讲，传统来说都是重新起一个worker来监听。但serverless环境里，这不work，一个worker跑最多一分钟就关掉了。之前我们的做法是重新整一台机器，在上边起这个docker，最大的问题还是运维：得时不时去机器上看看有没有问题对吧，并且新代码部署也得上去重启docker（当然也可以CI，但成本就又上来了）。
如果用Vercel serverless，他idiomatic的方式是起一个API Endpoint，然后通过在vercel.json里上cronjob，或者其他方式触发，都可以。现在我们就使用这种方式，每次触发，从上次取到的blockHeight+1开始，到最新的blockHeight结束。用getLogs的方式来解析日志。这样的好处是天然要做幂等，方便backfill。排错也更加容易了。
 
### 运营上
今晚听了北城同学组织的Space，题目是Web3新手小白找工作相关的，嘉宾是各位助教老师。特别好！真羡慕能说会道的朋友，自己这方面一直都不是很自信（小时候故事会说完第一句话当场哭了，大学联欢会唱完歌直接胃痉挛）
除了亲身经历了最终好的效果，还是很想能参与到他们筹备阶段，但这次确实不碰巧，希望下次可以！

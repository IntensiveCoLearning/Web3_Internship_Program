...
听了今日例会，深受同学们的启发。同学发言中提到了3blue1brown讲密码学和比特币的视频，遂观看学习。
...
### 信任基础：PoW（主要工具：密码哈希函数）

哈希函数：

Input：任意信息或文件

Output：256 bit string（Hash/Digest）

PoW：尝试了大量的Input所获得的符合“开头必须是n个零”的Hash的specific input

根据协议，会定期更换n的值，以实现发现新区快的平均时间为10分钟
...
2.是否经过专业机构的第三方审计或安全测试

3.是否具备KYC、AML等反洗钱与用户身份识别制度（**法律：知情推断**）

> **KYC（了解你的客户）**：
> 
> 
> KYC是指金融机构或其他服务提供商在与客户建立业务关系时，需要验证客户的身份，以确保其身份的合法性。KYC的目的是为了防止非法活动，比如洗钱、诈骗和恐怖融资等。常见的KYC措施包括：
> 
> - 收集客户的个人信息，如姓名、地址、身份证明文件等。
> - 确认客户的资金来源和交易目的。
> - 定期更新客户的身份信息和交易活动。
> 
> 通过KYC，机构能够更好地了解客户的背景和风险水平，从而防止利用其平台进行非法活动。
> 
> **AML（反洗钱）**：
> 
> AML是一系列用于打击洗钱活动的法律、规章和措施。洗钱是指通过一系列交易将非法获得的资金转化为看似合法的资金。AML的目的是防止犯罪分子通过金融系统隐藏不正当的资金来源。AML措施包括：
> 
> - 监控客户的交易活动，识别异常交易。
> - 定期报告可疑活动给监管机构。
> - 执行严格的客户身份验证和背景调查（即KYC）。
> - 对异常的交易进行调查，确保合法性。
...
2016年，出现大量ICO，17年出现各种乱象，国内取缔ICO，18年美国推出监管

**2017年，BM借ICO开启EOS项目（有史以来最大规模ICO）**，特点：

1.号称百万级别TPS（实际数千）

2.DPOS制度（21个超级节点，“人大代表”）

3.免除Gas费与账户模型

**2018年：Dapp爆发年**

eos和Steem的用户占比远高于ETH

市场份额游戏、博彩占比大，但也留下了如Uniswap等

**eos失败原因：**

1.过度中心化：DPoS的治理危机

会选：“你给我投票，我给你利益“ ，遇到会选/买票的治理机制，可以注意一下

2.资源模型设计失败

UST的稳定机制本质上是通过市场调节来维持其1:1的锚定美元。通过Luna的销毁与铸造，系统试图保持UST的稳定。然而，当市场信心丧失时，这种纯粹依赖市场自我调节的机制无法有效运行，导致了其崩溃。

“纯粹的奥派”

Luna的双币模型本质上是一个利用市场调控机制来维持UST的稳定性的系统。然而，这种设计过于依赖市场情绪，缺乏足够的抵抗力应对极端市场条件。当市场出现剧烈波动时，Luna和UST的稳定机制就未能有效支撑，导致了UST的脱锚以及Luna的暴跌。

RAM炒作：

”ram 可以简单理解成 gas，就是在他们平台上部署智能合约什么的，需要先购买 ram才能部署“

3.技术承诺未兑现

4.生态激励不足：资金耗尽、开发者流失，没有兑现对开发者的承诺，缺少开发者激励

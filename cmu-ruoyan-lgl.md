...
上午10:45  
今天是结营的最后一天，没想到已经过了一个月了，和这些还在大学的孩子们交流学习，是很能鼓舞我的，仿佛自己也回到了那个单纯、乐观、向上的年纪。  
昨天和bruce老师聊，发觉自己的很多东西确实是无需过多焦虑的：1是焦虑也没有效果，2是也无需焦虑，很多经历也证实了自己还是有能力去完成很多工作的，可能是我个人本就悲观且没有啥自信吧。  
刚刚看了看罗永浩的对新东方的求职信，感觉又得到了一点自信。  
一个28岁高中辍学生的人勇敢的去追求自己喜欢的事业，写了一个一万字的长文给当时如日中天的新东方的老总，只求一次面试经历和试岗。当时信息不发达达年代，有野心的年轻人都不怕被埋没，何况是现在呢。昨日的Licridity和bga的演讲深入我心，我想大概这是我喜欢岗位，就如布老师所言，在精不在多，积极准备就是了。
<!-- DAILY_CHECKIN_2025-08-29_END -->


# 2025-08-28
<!-- DAILY_CHECKIN_2025-08-28_START -->
今天还是整了整简历，发现这个真的是整不完的，越想体现全面越容易让hr抓不住重点淘汰。利弊权衡下，还是只保留一页。

最近有点心烦，感觉学不下去了，可能是最近腿伤和头疼的问题。今晚看jobs分享，又萌生了回web2做游戏的想法，可能我真的还是难以割舍那些游戏情怀吧，可能还是薪资的原因？感觉并不比我web2的薪资高，甚至远没有可比性（点名bty，简直是血汗工厂，还包装学习）。  
下午和bruce老师聊天，感觉下一步还是要把英语口语的能力找回来，找一份国外的工作才比较靠谱，国内的血汗工厂是一点也不能接受，至于国内的工作，还是先试一试面一面看看web3公司的常见面试场景，就当积攒经验了。  
晚上再整理一下自己的介绍，再看一看针对uniswapv4的学习资料，明天重点和jeff大哥聊聊合作了。
...
今大病  
没有学多少东西，构建了一下NFT market的结构，又继续改了改简历的网站，感觉转运营的方向可能是适合现在的我，好纠结现在，一方面又想继续做web2的游戏，一方面又讨厌当前web2的环境讨厌坐班，web3的游戏在我看来根本不行，从区块链技术上就没有前景，要是光资产上链后面的其他逻辑不对玩家公开的话还是觉得没有意思，做全链游戏依赖又很差，唉，发愁。继续看react了，可能感觉技术上还是找一份前端的or智能合约的会更适合我现在，运营和开发者关系方向还是继续试着找找吧。
<!-- DAILY_CHECKIN_2025-08-27_END -->


# 2025-08-25
<!-- DAILY_CHECKIN_2025-08-25_START -->
今天学了下figma入门，配置好了cursor 的 talk to figma插件，还是设计的非常好的  
一直在刷react的题目，疯狂补前端的知识  
求职上确实很焦虑现在，一方面自己确实没有做传统前后端的全职经验，唯一的经验是web3ton游戏，但是现在也不好找全职  
和gpt5聊了好久，心态上感觉好了点
...
整理黑客松思路
痛点：最近在做多链上的项目信息收集，想实现monitor，但是没有找到现成的，可以直接使用的库，mcp文件
目标：
所以就想实现一个去中心化的web3信息收集，希望通过技术上实现依赖机制
技术：
参考op rollup的挑战机制（两周挑战期，挑战也有挑战），构建池子，和sui的面向对象的概念，利用dai代币中mkr增发机制进行平衡（用户提交需要进行stake，以防虚假信息，需提前购买对应的合约币），

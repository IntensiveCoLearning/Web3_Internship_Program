...
我今天完成了对金库前端的调试，可以正常存取资金了，增加了暂停合约功能，增加了金库合约的交易抽成功能

# 2025-08-18

今天把前端代码进行了修改，金库代码跑通了，参加了介绍Farcaster的会议，还了解到了MCP服务器，及AI与区块链相结合的前景，收获颇丰

# 2025-08-17

今天参加了Hackthon的预热活动，结识许多朋友，获取了很多有意思的idea。之后今天的主要工作就是把AI Risk 金库的前端搭建完成并实现与后端的调试，把新结识的朋友的git拉取了下来，之后看一下大概的项目结构

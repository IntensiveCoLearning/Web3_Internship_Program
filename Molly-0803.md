...
技术向前端Logic： Bybit先锋的前端取经之路
技术后端向Jason：资深Web2开发者的转型之路
运营增长向Julie: 00后社区增长专家
用人方视角: Bruce谈如何成为靠谱的Web3实习生

# 2025-08-15

技术向前端Logic ：Bybit先锋的前端取经之路
在这一篇里我了解到了前端开发工程师Logic Bybit, 知道了他接触并加入web3的契机以及在LXDAO里主要做了运营助手活动统筹社区对接等工作以及他现在负责的一些业务和web2前端web3前端的差异等。

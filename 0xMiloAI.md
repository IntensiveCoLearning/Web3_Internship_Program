...
-   **教育与技术背景**：本科、硕士均为计算机专业，硕士研究跨学科方向；研究生期间跑过以太坊节点，有区块链实践经历。
    
-   **职业经历**：主业写 C/C++，也做 Android、iOS、HarmonyOS，正在逐步转向 Web3，未来计划赴港发展。
    
-   **契机**：受同学影响，感受到新加坡 Web3 氛围浓厚；结合个人研究和公司曾有区块链项目经验，坚定了转型决心。
...
-   **获取岗位渠道**：主要靠内推和线下社群，Web3 组织扁平，人际推荐比招聘平台更有效。
    
-   **对学生建议**：
    
    -   多实习：积累真实项目经验是最大加分项。
        
    -   打牢基础：面试更注重计算机底层知识（组成原理、IO、CPU/内存机制）。
        
-   **正向循环模式**：实习发现短板 → 回校补基础 → 再申请更有挑战的实习 → 持续提升。
...
-   **交易所专家岗面试**：侧重 CPU 分片、内存布局、缓存机制、文件 IO 等底层原理。
    
-   **原因**：无论 Web2 或 Web3，系统都运行在 CPU / 服务器上，理解底层原理对系统优化很重要。
...
-   **前端开发者**：迁移门槛最低，主要是更换包和接口。
    
-   **底层开发者**：语言迁移容易，但需要更强的产品思维，理解业务和生态才有价值。
    
-   **总体挑战**：缺少“超级应用”，所以需要跳出写代码思维，注重业务和生态。
...
-   **AI 辅助**：能生成/改写代码，但无法替代对业务场景和产品逻辑的理解。
    
-   **核心价值**：开发者需要主导产品决策和系统落地，这才是不可替代的。
...
-   **商科背景**：用数据分析工具（SQL、Superset）做链上数据归因和洞察。
    
-   **理工背景**：C/C++ 基础较好，转学 Solidity、Rust 较容易，建议跟官方/GitHub 项目实战。
    
-   **文科背景**：可做 BD、社区运营、内容策划等，Web3 不只是技术，也需要市场和传播人才。
